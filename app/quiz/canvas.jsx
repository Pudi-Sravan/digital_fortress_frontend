...
const COLOR_PALETTE_GLSL = Object.freeze({
	...
	white: "vec4(0.898, 0.898, 0.898, 1.0)",
	color1: "vec4(0.42, 1.0, 0.376, 1.0)",
	color2: "vec4(0.2, 1.0, 0.0, 1.0)",
	color3: "vec4(0.106, 0.8, 0.0, 1.0)",
	color4: "vec4(0.627, 1.0, 0.2, 1.0)",
	color5: "vec4(1.0, 0.909, 0.2, 1.0)",
	color6: "vec4(1.0, 0.843, 0.0, 1.0)",
	color7: "vec4(0.161, 0.196, 0.255, 1.0)",
	color8: "vec4(0.118, 0.165, 0.22, 1.0)",
	color9: "vec4(0.071, 0.071, 0.071, 1.0)",
	color10: "vec4(0.227, 0.227, 0.227, 1.0)",
})
...
export default FullScreen3DExample;